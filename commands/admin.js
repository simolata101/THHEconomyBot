...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(s=>s.setName('event').setDescription('Trigger a server-wide event').addStringOption(o=>o.setName('type').setRequired(true)))
    .addSubcommand(s=>s.setName('drawlottery').setDescription('Draw lottery (admin)'))
